document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'it': {
            ...
            'experience-coach': 'allenatore di pallavolo',
            ...
            'project-ecommerce-title': 'E-commerce',
            'project-ecommerce-description': 'Un\'applicazione di e-commerce con funzionalità complete per l\'acquisto e la gestione dei prodotti.',
            ...
            'project-webdev-title': 'Web Development',
            'project-webdev-description': 'Una raccolta di progetti e snippet per lo sviluppo web.',
        ...
        'en': {
            ...
            'p2': 'My passion for volleyball began in elementary school, where I discovered the value of teamwork. After nine years of playing experience, I now coach an Under 13 team because I strongly believe that sports are a true school of life: they taught me discipline, collaboration, and how to face challenges. More recently, I found in running a new outlet that has taught me perseverance and the importance of motivation.',
            'p3': 'My interest in the startup world exploded after meeting Vittorio Viarengo, who deeply inspired me. Thanks also to the support and teachings of people like Paolo Marenco and Simona Borghi, and through attending valuable conferences, I became closer to this stimulating environment. In 2024, I earned the CISCO Cybersecurity certification and, more recently, the AWS Cloud 101.',
            'p4': 'My goal is clear: to create useful and accessible technological solutions that can truly improve daily life. Every day is an opportunity to grow, learn, and become a better professional.',
            'p5': 'Recently, I rediscovered the world of children by working as a party entertainer. Surrounded by laughter, games, and colors, I learned to engage in a new way: slowing down, truly listening, and letting myself be amazed by the little things. This activity allows me to feel like a child again, observing reality with curious eyes, full of imagination and spontaneity. Working with kids requires empathy, creativity, and the ability to constantly reinvent yourself — qualities I find extremely valuable in both personal and professional growth.',
            'p6': 'I deeply believe that keeping this fresh and authentic outlook alive is essential to facing today\'s challenges with lightness and clarity. After all, staying a little bit childlike throughout life may be the secret to never stopping learning.',
            'coach-text': 'For one year, I coached an Under 13 team at CUS Genova Volley. The goal was not just to win, but also to instill a love for volleyball. I guided them in developing all the techniques of defense, attack, reception, and serving, helping them improve coordination and understand the importance of teamwork. This experience taught me the value of leadership, communication, and patience.',
            'animator-text': 'As an animator, I turned birthday parties and weddings into unforgettable events. My specialty? Somersaults on the clouds! Despite the playful name, this experience taught me how to manage an audience, work under pressure and to think creatively to solve problems on the spot. I honed my communication skills and learned to create an atmosphere of joy and lightheartedness, making every celebration a success.',
            'cert-css3-name': 'CSS3 Essentials',
            'cert-css3-desc': 'CSS3 Essentials certification. I learned the basics of CSS3, including layouts, responsive design, and animations to enhance the appearance of websites.',
            'project-alarion-title': 'Alarion',
            'project-alarion-description': 'A web development project to learn the basics of HTML and CSS.',
            'project-3d-title': '3D Website Tree',
            'project-3d-description': 'A 3D website created with three.js to explore the library\'s capabilities.',
            'project-cookie-title': 'Cookie Analyzer',
            'project-cookie-description': 'A web extension to analyze a site\'s cookies and their properties.',
            'project-dopamine-title': 'Dopamine Preview',
            'project-dopamine-description': 'A website preview focused on design and user experience.',
            'project-taskforge-title': 'Task Forge',
            'project-taskforge-description': 'A task manager for Windows, demonstrating the use of Python.',
            'contact-title': 'Contact',
            'contact-description': 'If you\'d like to get in touch with me, feel free to send me an email or find me on social media.',
            'email-text': 'Email',
            'linkedin-text': 'LinkedIn',
            'github-text': 'GitHub',
            ...
            'hero-subtitle': 'student and startup enthusiast',
            'about-title': 'About',
            'about-p1': 'Since I was a child, I\'ve been fascinated by technology and how things work. Over the years, I\'ve developed interests in web programming, robotics, and more recently, the startup world. My passion for volleyball started in elementary school, where I discovered the importance of teamwork. With nine years of experience, I now coach Under 13 boys because I believe sports are a true school of life.',
            ...
            'education-silicon': 'SILICON VALLEY STUDY TOUR 2025',
            'experience-title': 'Work Experiences',
            'experience-coach': 'volleyball coach',
            'experience-animator': 'animator',
            'cert-cybersecurity-name': 'Introduction to Cybersecurity',
            'cert-aws-name': 'AWS Educate Introduction to Cloud 101',
            'cert-business-name': 'Managing a Business Venture',
            'cert-placeholder': 'Select a certification to see the details.',
            'cert-cybersecurity-desc': 'CISCO Cybersecurity certification obtained in 2024. I learned the basics of IT security, data protection, and online threat prevention.',
            'cert-aws-desc': 'AWS Cloud 101 certification. I acquired the fundamental concepts of cloud computing, AWS services, and the benefits of migrating to the cloud for businesses.',
