document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
    'it': {
        'p1': 'Fin da piccolo mi affascinano tecnologia e innovazione. Ho esplorato il web, la robotica e lo sport: nove anni di pallavolo, ora mi sto concentrando su idee, progetti e innovazione.',
        'p2': 'L’incontro con figure ispiranti mi ha avvicinato al punto tale di iniziare a lavorare su me stesso più che mai.',
        'p3': 'Voglio creare soluzioni utili, semplici e accessibili cercando di avvicinare giovani come me al mondo delle startup.',
    ...
    'en': {
        'p1': 'Since childhood, I’ve been fascinated by technology and innovation. I explored the web, robotics, and sports: nine years of volleyball, and now I’m focusing on ideas, projects, and innovation.',
        'p2': 'Meeting inspiring people brought me to the point of working on myself more than ever before.',
        'p3': 'I want to create useful, simple, and accessible solutions while encouraging young people like me to approach the startup world.',
